...
let wpDependencies = ['blocks', 'components', 'date', 'editor', 'element', 'i18n', 'data', 'compose'];
...
mix.setPublicPath('dist')
    ...
    .webpackConfig({
        ...
        externals: wpDependencies.reduce((externals, wpDependency) => {
                externals[`@wordpress/${wpDependency}`] = {window: ['wp', wpDependency]};
                return externals;
            },
            {
                'lodash': 'lodash',
