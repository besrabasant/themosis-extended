<div {!! $__form->attributes(array_merge(['class' => 'admin-page__form'], $__form->getOption('container_attr', []))) !!}>
    {!! $__form->open() !!}
        ...
        @foreach($__form->repository()->getGroups() as $group)
            <div class="{{ sprintf('admin-page__field-group %s', sprintf('admin-page__field-group--%s', $group->getId())) }}">
